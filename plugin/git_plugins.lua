vim.pack.add({
    ...
    "https://github.com/nvim-lua/plenary.nvim",         -- Neogit: required
    "https://github.com/nvim-telescope/telescope.nvim", -- Neogit: optional
...
-- Example Keymap
vim.keymap.set('n', '<leader>df', diff_current_file_with_branch,
    { desc = 'Diffview: [D]iffview Compare [F]ile with Branch' })
